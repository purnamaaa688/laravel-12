      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="index.html" class="menu-link">
                <i class="menu-icon tf-icons bx bx-tired"></i>
            ...
            <li class="menu-item">
              <a href="index.html" class="menu-link">
                ...
                <div data-i18n="Analytics">alamat</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="index.html" class="menu-link">
                <i class="menu-icon tf-icons bxr bx-calender"></i>
                <div data-i18n="Analytics">tempat tanggal lahir</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="index.html" class="menu-link">
                <i class="menu-icon tf-icons bxr bx-bookmark"></i>
                <div data-i18n="Analytics">nis</div>
              </a>
            </li>
